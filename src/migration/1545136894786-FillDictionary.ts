...
export class FillDictionary1545136894786 implements MigrationInterface {
    ...
    private step2html = '<p>Программа <strong>CONTROL YOURSELF</strong>.</p>' +
        '<p>Тестирование и "пробное обучение".</p>' +
        '<br>' +
        '<p>Проверка начального лексического запаса на английском, французском и немецком языках.</p>' +
        '<p>Определение лингвистических способностей к усвоению иностранного языка в режиме автоматизированного обучения.</p>' +
        '<br>' +
        '<p>Процедура тестирования занимает около 2 часов.</p>' +
        '<p>Приступайте к работе только в том случае, если Вы уверены, что ничто не будет Вам мешать.</p>' +
        '<p>Отключите телефон, устраните все другие отвлекающие моменты. Это необходимо сделать потому, что некоторые задания выполняются с контролем затраченного на их выполнение времени.</p>';

    private mnemHtml = '<p>Сейчас Вы увидите на экране список из 50-ти пар слов на русском языке.</p>' +
        '<p>Ваша задача в течение 3-х минут запомнить как можно больше пар.</p>' +
    ...
    private selfRating = '<p>Вы видите шкалу самооценки речевых навыков общения на иностранном языке.</p>' +
        ...
        '<p>С помощью мыши Вам надо выбрать и отметить тот уровень, которым Вы владеете в данный момент, можете указать несколько уровней.</p>' +
        '<br>' +
        '<p>Если и готовы к работе, нажмите кнопку Продолжить</p>';

    private selfLex = '<p>Сейчас Вам будет предъявлено по 25 слов на английском, немецком и французском языках. Постарайтесь перевести на русский язык все известные вам слова.</p> <p>Внимательно просмотрите списки на всех трех языках, даже если какие либо из них Вы не изучали. В тестах есть такие интернациональные слова, которые Вам наверняка знакомы.</p> <p>Ваша задача - выбрать правильный перевод каждого слова и переместить его на прямоугольник справа от иностранного слова.</p>  <p>Если Вы сомневаетесь в правильности подставленного значения слова, щелкните мышкой по знаку вопроса слева от иностранного слова.</p> <p>По результатам этого теста мы определим язык пробного обучения.</p>';
    ...
    private fields = {
        ...
        phases: ['step', 'phase', 'num', 'action', 'result', 'title', 'scope', 'text', 'sounds', 'soundVolume', 'mode', 'time', 'next', 'stages', 'pages', 'component', 'video'],
    ...
    private mnemic = [
        ...
        {word1: 'будущее', word2: 'писать', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'мех', word2: 'минута', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'цвет', word2: 'зал', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'почва', word2: 'потеря', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'получать', word2: 'сила', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'ответ', word2: 'пищать', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'берег', word2: 'рюмка', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'атом', word2: 'власть', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'медь', word2: 'архив', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},

        {word1: 'цветок', word2: 'мир', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'характер', word2: 'характер', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'сердце', word2: 'сад', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'факт', word2: 'конец', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'один', word2: 'смотреть', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'рука', word2: 'пилот', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'ребенок', word2: 'город', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'орган', word2: 'оружие', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'пила', word2: 'писатель', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'класс', word2: 'близко', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},

        {word1: 'спускать', word2: 'осень', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'базар', word2: 'облако', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'малыш', word2: 'пища', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'бак', word2: 'мебель', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'круг', word2: 'рыба', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'большой', word2: 'машина', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'приходить', word2: 'рассматривать', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'кровать', word2: 'сарай', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'появляться', word2: 'нравиться', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'спрашивать', word2: 'план', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},

        {word1: 'разбивать', word2: 'мачта', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'сражение', word2: 'мечта', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'обложка', word2: 'отвечать', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'разница', word2: 'уметь', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'принимать', word2: 'окоп', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'тяжелый', word2: 'русло', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'складывать', word2: 'арбуз', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'высокий', word2: 'праздник', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'рассказ', word2: 'экран', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'разделять', word2: 'дело', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},

        {word1: 'явление', word2: 'туман', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'действовать', word2: 'озеро', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'сооружение', word2: 'ходить', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'возраст', word2: 'склад', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'правительство', word2: 'земля', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'преследовать', word2: 'аромат', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'воздух', word2: 'сено', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'основа', word2: 'подарок', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'расти', word2: 'день', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
        {word1: 'туловище', word2: 'балет', lang1: 'RU', lang2: 'RU', scope: 'mnemic::test'},
    ];
...
// PAGE
    ...
    //         action: 'BRIEF',
    //         result: '',
    //         title: 'Контроль - Мнемический тест',
    //         scope: '',
    ...
    //         action: 'BRIEF',
    //         result: 'mnemic',
    //         title: 'Предъявление/интерпретация результатов - мнемический тест',
    //         scope: 'Приложение 2',
    //         text: '<p>Вы запомнили  <strong>{{REMEMBERED}}</strong> слов <strong>({{REMEMBERED_PERCENT}}%)</strong></p>  <p><strong>{{RECOMMENDATION}}</strong></p>',
    //         sounds: '{{SOUNDTHEME}}/04.mp3',
    //         soundVolume: 20,
    //         mode: 'CYCLE',
    //         time: 0,
    ...
    //         text: '',
    //         sounds: '{{SOUNDTHEME}}/14.mp3#{{SOUNDTHEME}}/15.mp3#{{SOUNDTHEME}}/16.mp3',
    //         soundVolume: 20,
    //         mode: 'RANDOM_CYCLE',
    //         time: 600,
    //         next: 1,
