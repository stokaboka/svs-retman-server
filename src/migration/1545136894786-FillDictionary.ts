...
export class FillDictionary1545136894786 implements MigrationInterface {
    ...
    private vocabulary = [
        ...
        { word1: 'la campagne', word2: 'Загород, сельская местность ', lang1: 'FR', lang2: 'RU', scope: 'vocabulary::learn' },
        ...
        { word1: 'cet', word2: 'этот (для слов начинающихся на гласную букву) ', lang1: 'FR', lang2: 'RU', scope: 'vocabulary::learn' },
        ...
        { word1: 'une étagère', word2: 'этажерка, полка, стеллаж ', lang1: 'FR', lang2: 'RU', scope: 'vocabulary::learn' },
        ...
        { word1: 'il y a', word2: 'есть, имеется, находится (оборот для обстоятельства места) ', lang1: 'FR', lang2: 'RU', scope: 'vocabulary::learn' },
    ...
    private lessons = [
        ...
        { word1: '- These are telephones.', word2: '- Это телефоны.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- What are these?', word2: '- Что это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- What are those?', word2: '- Что это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Those are cars.', word2: '- Это легковые машины.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },

        { word1: '- What are those?', word2: '- Что это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Those are offices.', word2: '- Это офисы.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- What are these?', word2: '- Что это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- These are cars and buses.', word2: '- Это легковые машины и автобусы.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- What are those?', word2: '- Что это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Those are trees and flowers.', word2: '- Это деревья и цветы.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- What are these?', word2: '- Что это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- These are points, lines and figures.', word2: '- Это точки, линии и фигуры.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::1' },

        { word1: '- Is this a telephone?', word2: '- Это телефон?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Yes, this is a telephone.', word2: '- Да, это телефон.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is this a book?', word2: '- Это книга?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No, this is not a book.', word2: '- Нет, это не книга.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is this a hospital?', word2: '- Это больница?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No, this isn’t a hospital.', word2: '- Нет, это не больница.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is that a school?', word2: '- Это школа?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Yes, that’s a school.', word2: '- Да, это школа.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is that an airport?', word2: '- Это аэропорт?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No, that is not an airport.', word2: '- Нет, это не аэропорт.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is that a field?', word2: '- Это поле?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No that isn’t a field.', word2: '- Нет, это не поле.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is that a flower?', word2: '- Это цветок?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No that’s not a flower.', word2: '- Нет, это не цветок.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Are these ships?', word2: '- Это пароходы?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Yes, these are ships.', word2: '- Да, это пароходы.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Are these guides?', word2: '- Это проводники?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No, these are not guides.', word2: '- Нет, это не проводники.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Are these horses?', word2: '- Это кони?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No, these aren’t horses.', word2: '- Нет, это не кони.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },

        { word1: '- Are those reports?', word2: '- Это отчёты?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Yes, those are reports.', word2: '- Да, это отчёты.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Are those shops?', word2: '- Это магазины?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No, those are not shops.', word2: '- Нет, это не магазины.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Are those stones?', word2: '- Это камни?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No, those aren’t stones.', word2: '- Нет, это не камни.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is that a book?', word2: '- Это книга?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No, that’s not a book.', word2: '- Нет, это не книга.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        ...
        { word1: '- No, these aren’t letters.', word2: '- Нет, это не письма.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        ...
        { word1: '- No, those aren’t pictures.', word2: '- Нет, это не картины.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        ...
        { word1: '- No, this isn’t a train.', word2: '- Нет, это не поезд.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        ...
        { word1: '- Yes, that’s, a wall.', word2: '- Да, это стена.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Aren’t those steps?', word2: '- Разве это не ступеньки?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Yes, those are steps.', word2: '- Да, это ступеньки.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        ...
        { word1: '- These are cards and papers.', word2: '- Это карты и газеты.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is this a book?', word2: '- Это книга?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Yes, this is a book.', word2: '- Да, это книга.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Aren’t these stamps?', word2: '- А это разве не марки?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- No, these aren’t stamps.', word2: '- Нет, это не марки.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is this a pen or a pencil?', word2: '- Это ручка или карандаш?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- This is a pencil and that is a pen.', word2: '- Это карандаш, а это ручка.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is that a dog or a cat?   ', word2: '- Это собака или кот?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- That is a cat but that is a dog.', word2: '- Это кот, а это собака.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },

        { word1: '- These are apples, but those are oranges.', word2: '- Это яблоки, а это апельсины.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Are those socks or stockings?', word2: '- Это носки или чулки?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Those are socks and those are stockings.', word2: '- Это носки, а это чулки.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is this rubber or metal?', word2: '- Это резина или металл?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- This is metal, but that is rubber.', word2: '- Это металл, а это резина.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Is that plastic or glass?', word2: '- Это пластмасса или стекло?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- That is plastic and this is glass.', word2: '- Это пластмасса, а это стекло.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::2' },
        ...
        { word1: '- These are things, too.', word2: '- Это тоже предметы.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },

        { word1: '- But these aren’t things.', word2: '- А это не предметы.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- No, these are persons.', word2: '- Нет, это люди.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },

        { word1: '- And aren’t those persons?', word2: '- А разве это не люди?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Yes, those are persons, too.', word2: '- Да, это тоже люди.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },

        { word1: '- Who is this?', word2: '- Кто это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- This is my cousin.', word2: '- Это мой двоюродный брат.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        ...
        { word1: '- Those are his brothers.', word2: '- Это его братья.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        ...
        { word1: '- Yes, this is my hat.', word2: '- Да, это моя шляпа.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Are these your gloves?', word2: '- Это ваши перчатки?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- No, these aren’t my gloves.', word2: '- Нет, это не мои перчатки.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- These are her gloves.', word2: '- Это ее перчатки.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Is this her bag or is this your bag?', word2: '- Это её сумка или ваша сумка?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- This is her bag.', word2: '- Это её сумка.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- This isn’t my bag.', word2: '- Это не моя  сумка.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- And what are these?', word2: '- А это что?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- These are my stockings.', word2: '- Это мои чулки.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Are these your shoes?', word2: '- Это ваши туфли?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- No, these aren’t my shoes.', word2: '- Нет, это не мои туфли.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- These are his shoes.', word2: '- Это его туфли.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Who are these?', word2: '- Кто это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- These are our friends.', word2: '- Это наши друзья (приятели).', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Aren’t those your friends, too?', word2: '- А разве это не тоже ваши друзья?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- No, those aren’t my friends.', word2: '- Нет, это не мои друзья.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Those are my cousins.', word2: '- Это мои двоюродные братья/сестры.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },

        { word1: '- And who’s this?', word2: '- А это кто?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- This is my teacher.', word2: '- Это мой учитель.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Who are those?', word2: '- Кто это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Those are his students.', word2: '- Это его студенты.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Aren’t those your colleagues?', word2: '- А разве это не ваши коллеги?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Oh, yes, those are my     colleagues.', word2: '- О, да, это мои коллеги.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- What is this?', word2: '- Что это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- This is a table and this is its leg.', word2: '- Это стол, а это его ножка.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- And what is that?', word2: '- А это что?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- That’s a dog and that’s its owner.', word2: '- Это собака, а это её хозяин.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- What is this?', word2: '- Что это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- This is a child and this is its father.', word2: '- Это ребёнок, а это его отец.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- What’s this?', word2: '- Что это?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- This is a car and these are its wheels.', word2: '- Это машина, а это её колёса.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },

        { word1: '- Is this your house?', word2: '- Это ваш дом?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Yes, this is my house.', word2: '- Да, это мой дом.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Isn’t this your garden?', word2: '- А разве это не ваш сад?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Yes, this is my garden.', word2: '- Да, это мой сад.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Is this your wife?', word2: '- Это ваша жена?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Yes, this is my wife.', word2: '- Да, это моя жена.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- And who are these girls?', word2: '- А кто эти девочки?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- These girls are my daughters.', word2: '- Эти девочки мои дочери.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Are those boys your sons?', word2: '- Эти мальчики ваши сыновья?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Yes, those boys are my sons.', word2: '- Да, эти мальчики мои сыновья.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- And is this your dog?', word2: '- А это ваша собака?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Yes, this is my dog.', word2: '- Да, это моя собака.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- Is this your car?', word2: '- Это ваша машина?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- No, this isn’t my car.', word2: '- Нет, это не моя машина.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },
        { word1: '- That is my car.', word2: '- Моя машина та.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::3' },

        { word1: '- Good morning. I am Mary. Who are you?', word2: '- Доброе утро. Я - Мария. А вы кто?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Good morning. I’m Tom. And this is Michael.', word2: '- Доброе утро. Я - Том. А это Михаил.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Is Michael your brother?', word2: '- Михаил твой брат?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- No, he isn’t my brother. He’s my friend. A very good friend.', word2: '- Нет, он не мой брат. Он мой друг. Очень хороший друг.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- I’m a student. Are you also a student, Tom?', word2: '- Я - студентка. Ты тоже студент, Том?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Yes, I am.', word2: '- Да.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- And Michael is also a student, I think?', word2: '- А Михаил, наверное, тоже студент?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Yes, he is. What’s your subject, Mary?', word2: '- Да, он студент. Что ты изучаешь, Мария?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- My subject is chemistry.', word2: '- Я изучаю химию (досл.: Мой предмет - химия).', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- And my subject is political economy.', word2: '- А я изучаю политическую экономику. (А мой предмет - это политэкономика).', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },

        { word1: '- And what’s your subject, Michael?', word2: '- А ты что изучаешь. Михаил?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- My subject is history.', word2: '- Я изучаю историю.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- History is very interesting.', word2: '- История - очень интересный предмет.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Isn’t political economy interesting, too?', word2: '- Разве политическая экономика не такой же интересный предмет?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Oh, yes, it is.', word2: '- О, да (очень интересный).', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- What’s your last name, please?', word2: '- Ваша фамилия, пожалуйста?  (Как ваша фамилия?).', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- My last name’s Compton.', word2: '- Моя фамилия Комптон.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Who is that man?', word2: '- Кто этот мужчина?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- He’s Mr. Hunter.', word2: '- Это господин Хантер.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        ...
        { word1: '- Is that tall woman his wife?', word2: '- А эта высокая женщина его жена?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- No, she isn’t. She’s Mrs. Pitman.', word2: '- Нет. Это госпожа Питман.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- What’s she?', word2: '- Кто она такая?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- She’s a nurse.', word2: '- Она - медицинская сестра.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- What’s her husband?', word2: '- А кто её муж?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Her husband’s a postman.', word2: '- Её муж почтальон.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },

        { word1: '- And this is Dr. Brown, I think.', word2: '- А это, наверное, доктор Браун.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- That’s right. This lady is Dr. Brown.', word2: '- Правильно. Эта женщина - доктор Браун.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Is that old gentleman her husband?', word2: '- Этот пожилой мужчина её муж?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- You’re right. He’s also Dr. Brown.', word2: '- Правильно. Он также доктор Браун.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- And those girls and boys are their children, aren’t they?', word2: '- А эти девочки и мальчики их дети, не так ли?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- You’re right again.', word2: '- Вы опять угадали. (Вы снова правы).', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- A big family. Is Dr. Brown a physician?', word2: '- Большая семья. Доктор Браун - врач?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- No, he isn’t. His wife is. He’s a lawyer.', word2: '- Нет, он не врач. Его жена - врач. Он - юрист.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },

        { word1: '- Who are those two people?', word2: '- Кто эти два человека?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- They are Mr. and Mrs. Miller.', word2: '- Это господин и госпожа Миллер.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        ...
        { word1: '- Is that young man their son?', word2: '- Этот молодой человек их сын?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        ...
        { word1: '- And who’s that elegant woman?', word2: '- А кто эта элегантная женщина?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- She is Miss Miller.', word2: '- Это мисс Миллер.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Miss Miller is a painter, I think?', word2: '- Мисс Миллер, кажется, художница?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Yes, she is a famous painter. Her pictures are very good.  ', word2: '- Да, она известная художница. Её картины очень хорошие.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- This is Mr. Sharp, my friend.', word2: '- Это господин Шарп, мой приятель.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- And this is my teacher, Mr. Bell.', word2: '- А это мой учитель, господин Бел.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },

        { word1: '- How do you do, Mr. Bell?', word2: '- Здравствуйте, господин Белл.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- How do you do, Mr. Sharp?', word2: '- Здравствуйте, господин Шарп.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Is Mrs. Florence Sharp your wife?', word2: '- Госпожа Флоренс Шарп ваша жена (супруга)?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Yes, Mrs. Florence Sharp is my wife.', word2: '- Да, госпожа Флоренс Шарп - моя жена.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Is that your school, Mr. Bell?', word2: '- Это ваша школа, господин Белл?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Yes, it is.', word2: '- Да.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- And those small boys and girls are your pupils, I think.', word2: '- А эти маленькие мальчики и девочки, кажется, ваши ученики?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- You’re right. They’re my pupils.', word2: '- Вы правы. Это мои ученики.', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
        { word1: '- Are they good pupils?', word2: '- Они хорошие ученики?', lang1: 'EN', lang2: 'RU', scope: 'test::lesson::4' },
...
// DE L 1
        ...
        { word1: '- Was ist das hier?', word2: '- Что это здесь такое?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- Das ist ein Baum, und dort ist ein Strauch.', word2: '- Это дерево, а там - куст.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- Was für ein Tier ist das?', word2: '- Что это за животное?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das ist ein Hund.', word2: '- Это собака.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Und was für ein Tier ist das?', word2: '- А это что за животное?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das ist eine Katze.', word2: '- Это кошка.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Und was ist das da oben?', word2: '- А что это там наверху?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- Nein, das ist ein Esel.', word2: '- Нет, это осел.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Hier ist eine Wohnung.', word2: '- Здесь квартира.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Was ist das, bitte?', word2: '- Скажите, пожалуйста, что это такое?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das ist eine Tischdecke.', word2: '- Это скатерть.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Und was ist das hier?', word2: '- А здесь что такое?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das ist ein Teller.', word2: '- Это тарелка.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Und das ist ein Glas.', word2: '- А это стакан.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Und was ist das, bitte?', word2: '- Скажите, пожалуйста, а что это?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das ist eine Tasse.', word2: '- Это чашка.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },

        { word1: '- Hier ist ein Besteck:  ein Messer, eine Gabel und ein Löffel.', word2: '- Здесь столовые приборы: нож, вилка и ложка.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Danke. Und was ist das dort?', word2: '- Спасибо. А что здесь такое?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das ist eine Schüssel.', word2: '- Это миска.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Die Schüssel ist rund.', word2: '- Миска круглая.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Was ist das hier?', word2: '- Что здесь такое?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das ist Zucker. Der Zucker ist süß.', word2: '- Это сахар. Сахар сладкий.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Was ist das hier?', word2: '- А что здесь такое?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das ist Salz und Pfeffer.', word2: '- Это соль и перец.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- Das ist Essig und Öl.', word2: '- Это уксус и растительное масло.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- Und was ist das, bitte?', word2: '- А это что такое?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das ist Brot und Butter.', word2: '- Это хлеб и масло.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das Brot ist schwarz, die Butter is frisch.', word2: '- Хлеб черный, масло свежее.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- Das ist der Vater, das ist die Mutter.', word2: '- Это отец, это мать.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Das sind die Kinder: das ist der Sohn, das ist die Tochter.', word2: '- Это дети: это сын, это дочь.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Vater und Mutter sind die Eltern. Sie sind gut.', word2: '- Отец и мать - родители. Они хорошие.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- Karin lernt sehr gut.', word2: '- Карин учится очень хорошо.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Sie treiben auch Sport.', word2: '- Они также занимаются спортом.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::1' },

        // DE L 2
        { word1: '- Guten Tag, Frau Kröger!', word2: '- Здравствуйте, госпожа Крегер!', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Guten Tag, Frau Nowak, wieder in Berlin?', word2: '- Здравствуйте, госпожа Новак, снова в Берлине?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Ja, wieder in Berlin.', word2: '- Да, снова в Берлине.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Wo ist Herr Kröger?', word2: '- Где господин Крегер?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        ...
        { word1: '- Und wo ist Fräulein Karin?', word2: '- А где барышня Карин?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Karin studiert in Moskau. Kennen Sie Karin?', word2: '- Карин учится в Москве. Вы знаете Карин?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Nein, leider nicht. Wie ist sie denn?', word2: '- Нет, к сожалению, нет. Какая она (из себя)?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Wollen sie eine Beschreibung?', word2: '- Вы хотите (ее) описание?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },

        // DE L 2 - ???
        { word1: '- Die Haare sind blond und glatt.', word2: '- Волосы светло-русые и ровные.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Die Augen sind braun. Der Mund ist klein und schmal, die Nase ist gerade.', word2: '- Глаза карие. Рот маленький и узкий, нос прямой.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Wie ist die Stirn, wie sind die Ohren?', word2: '- Какой у нее лоб, какие уши?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Die Stirn ist hoch, die Ohren sind zierlich.', word2: '- Лоб высокий, уши изящные.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Ist sie blaß?', word2: '- Она бледная?', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Nein, die Wangen sind rosig, die Zähne sind weiß.', word2: '- Нет, щеки розовые, зубы белые.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Die Hände sind schmal, und die Füße sind klein.', word2: '- Руки узкие, а ступни ног маленькие.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        { word1: '- Die Beine sind schlank und lang.', word2: '- Ноги стройные и длинные.', lang1: 'DE', lang2: 'RU', scope: 'test::lesson::2' },
        ...
        { word1: '- Monsieur Jacques Vernet est un homme.', word2: '- Господин Жак Верне - мужчина.', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Voici une femme.', word2: '- Вот женщина.', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- C’est madame Jeanne Vernet.', word2: '- Это госпожа Жанна Верне.', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Madame Jeanne Vernet est une femme.', word2: '- Госпожа Жанна Верне - это женщина.', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
...
// PAGE
        ...
        { word1: '- C’est madame Jeanne Vernet.', word2: '- Это госпожа Жанна Верне.', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
        { word1: '- Et ce jeune homme?', word2: '- A этот молодой человек?', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- Jean est mon ami.', word2: '- Жан - это мой друг.', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
...
// PAGE
        ...
        { word1: '- Et voici des meubles.', word2: '- A вот мебель.', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- C’est une phono, et voici des disques.', word2: '- Это проигрыватель, а вот пластинки.', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
...
// PAGE
        ...
        { word1: '- Voici le plafond, le plancher, les murs, la porte et les fenêtres de la chambre.',
            word2: '- Вот потолок, пол, стены, дверь и окна комнаты.', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
        ...
        { word1: '- C’est la table et ce sont les livres de Pierre.', word2: '- Это стол, а это книги Пьера.', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
...
// PAGE
        ...
        { word1: '- Il est assis devant la table.', word2: '- Он сидит за столом (досл.: перед столом).', lang1: 'FR', lang2: 'RU', scope: 'test::lesson::1' },
...
// PAGE
    ...
    private phases = [
        ...
        { step: 4,
            ...
            title: 'Самооценка речевых навыков в общенении на английском, немецком и французском языках',
            scope: '',
            text: 'Тестируемый должен оценить свои навыки общения для трех языков (английский/ немецкий/ французский)',
            sounds: '',
            mode: 'CYCLE',
            time: 0,
            next: 1,
        ...
        { step: 6,
            ...
            scope: '',
            text: 'Подумайте и оцените следующие параметры Вашего состояния: самочувствия, активности и настроения, в соответствии с условной шкалой, где середина шкалы – норма',
            sounds: '',
            mode: '',
            time: 0,
            next: 1,
        ...
        { step: 6,
            ...
            title: 'Аутотренинг',
            scope: '',
            text: 'Для того чтобы настроиться на эффективную работу во время пробного обучения, предлагаем Вам самостоятельно проделать упражнения по аутогенной тренировке (АТ). Устройтесь поудобнее, устраните все отвлекающие факторы. Внимательно слушайте инструкции, с полной самоотдачей выполняйте упражнения. Длительность АТ- 6 мин 20 сек',
            sounds: '',
            mode: '',
            time: 0,
            next: 1,
        ...
        { step: 6,
            ...
            title: 'Предъявление/интерпретация результатов',
            scope: '',
            text: 'Ваше самочувствие до проведения аутотренинга: <strong>{{AUTOSELFBEFORE}}</strong>, после аутотренинга: <strong>{{AUTOSELFAFTER}}</strong>. </br><strong>{{AUTOSELFRECOMENDATION}}</strong>',
            sounds: '',
            mode: '',
            time: 0,
            next: 1,
        ...
        { step: 7,
            ...
            title: '',
            scope: '',
            text: 'Приступаем к пробному обучению. Вам будут предъявлены озвученные тексты на <strong>{{LANGUAGE_NAME}}</strong> языке с параллельным переводом. Вы должны будете слушать в левом наушнике тексты на <strong>{{LANGUAGE_NAME}}</strong> языке, а в правом наушнике их перевод. Старайтесь читать текст вместе с диктором вслух или громко повторять за ним. Всего тексты уроков будут предъявлены 4 раза подряд. Общая длительность уроков -  <strong>{{STEP_7_TIME}}</strong>',
    ...
    private lessonStages = [
        ...
        // LESSON 1 EN
        { lang: 'EN', title: 'отмечать знакомые иностранные слова',                            step: 7, lesson: 1, stage: 1, pages: 3, scope: 'test::lesson::1', sound: 'less1_eng-ru.mp3',    time: 0 },
        ...
        { lang: 'EN', title: 'отмечать <strong>дословно</strong> понятные иностранные фразы',  step: 7, lesson: 1, stage: 4, pages: 3, scope: 'test::lesson::1', sound: 'less1_eng.mp3',       time: 0 },

        // LESSON 2 EN
        { lang: 'EN', title: 'отмечать знакомые иностранные слова',                            step: 7, lesson: 2, stage: 1, pages: 4, scope: 'test::lesson::2', sound: 'less2_eng-ru.mp3',    time: 0 },
        ...
        { lang: 'EN', title: 'отмечать <strong>дословно</strong> понятные иностранные фразы',  step: 7, lesson: 2, stage: 4, pages: 4, scope: 'test::lesson::2', sound: 'less2_eng.mp3',       time: 0 },

        // LESSON 3 EN
        { lang: 'EN', title: 'отмечать знакомые иностранные слова',                            step: 7, lesson: 3, stage: 1, pages: 4, scope: 'test::lesson::3', sound: 'less3_eng-ru.mp3',    time: 0 },
        ...
        { lang: 'EN', title: 'отмечать <strong>дословно</strong> понятные иностранные фразы',  step: 7, lesson: 3, stage: 4, pages: 4, scope: 'test::lesson::3', sound: 'less3_eng.mp3',       time: 0 },

        // LESSON 4 EN
        { lang: 'EN', title: 'отмечать знакомые иностранные слова',                            step: 7, lesson: 4, stage: 1, pages: 5, scope: 'test::lesson::4', sound: 'less4_eng-ru.mp3',    time: 0 },
        ...
        { lang: 'EN', title: 'отмечать <strong>дословно</strong> понятные иностранные фразы',  step: 7, lesson: 4, stage: 4, pages: 5, scope: 'test::lesson::4', sound: 'less4_eng.mp3',       time: 0 },

        // LESSON 1 DE
        { lang: 'DE', title: 'отмечать знакомые иностранные слова',                            step: 7, lesson: 1, stage: 1, pages: 5, scope: 'test::lesson::1', sound: 'less1_deu-ru.mp3',    time: 0 },
        ...
        { lang: 'DE', title: 'отмечать <strong>дословно</strong> понятные иностранные фразы',  step: 7, lesson: 1, stage: 4, pages: 5, scope: 'test::lesson::1', sound: 'less1_deu.mp3',       time: 0 },

        // LESSON 2 DE
        { lang: 'DE', title: 'отмечать знакомые иностранные слова',                            step: 7, lesson: 2, stage: 1, pages: 1, scope: 'test::lesson::2', sound: 'less2_deu-ru.mp3',    time: 0 },
        ...
        { lang: 'DE', title: 'отмечать <strong>дословно</strong> понятные иностранные фразы',  step: 7, lesson: 2, stage: 4, pages: 1, scope: 'test::lesson::2', sound: 'less2_deu.mp3',       time: 0 },

        // LESSON 1 FR
        { lang: 'FR', title: 'отмечать знакомые иностранные слова',                            step: 7, lesson: 1, stage: 1, pages: 12, scope: 'test::lesson::1', sound: 'less1_fre-ru.mp3',    time: 0 },
