...
export class InitDatabase1544706296141 implements MigrationInterface {
    ...
    private tablePhases: Table = new Table({
        ...
        //     { name: 'scope',    type: 'varchar',    length: '255' },
        //     { name: 'briefText',     type: 'varchar',    length: '1000' },
        //     { name: 'briefSounds',    type: 'varchar',    length: '1000' },
        //     { name: 'briefModeSounds',    type: 'varchar',    length: '100' },
        //     { name: 'briefTime',     type: 'int' },
        //     { name: 'testText',     type: 'varchar',    length: '1000' },
        //     { name: 'testSounds',    type: 'varchar',    length: '1000' },
        //     { name: 'testModeSounds',    type: 'varchar',    length: '100' },
        //     { name: 'testNextBtn',     type: 'int' },
